...
- **Auto-generated titles** — leave `Title` blank and the session is named from your first message: from the initial prompt if you provide one, otherwise from the first message you send once the session is running. An explicit title is always kept as-is.
