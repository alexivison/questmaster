...
- Picker-selected session colors now seed the repository color for new repos, stamp session color changes for last-write-wins resolution, and survive explicit worker spawns.
